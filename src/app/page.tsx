...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/middle-aged-delivery-woman-blue-uniform-cap-holding-cardboard-box-clipboard-looking-it-smiling-standing-pink-wall_141793-71945.jpg",
          alt: "Michael Brown",
        },
      ]}
  ...
  <div id="about" data-section="about">
      ...
      bulletPoints={[
        {
          title: "Global Reach",
          description: "Extensive network connecting continents and markets.",
          icon: Globe,
        },
        {
          title: "Reliable Service",
          description: "On-time delivery and secure handling for every shipment.",
          icon: ShieldCheck,
        },
        {
          title: "Custom Solutions",
          description: "Tailored logistics to meet unique business needs.",
          icon: Settings,
        },
      ]}
      ...
      metrics={[
        {
          ...
          description: "Ensuring your cargo arrives precisely when expected, every single time.",
          icon: CheckCircle,
        },
        {
          id: "em2",
          ...
          description: "Building lasting relationships through reliable service and exceptional support.",
          icon: Users,
        },
        {
          id: "em3",
          ...
          description: "Always available to assist with your logistics needs, anytime, anywhere.",
          icon: LifeBuoy,
        },
      ]}
    />
