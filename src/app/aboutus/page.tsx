      ...
      bulletPoints={[
        {
          ...
          description: "Built on a foundation of reliability and customer-first approach.",
          icon: Lightbulb,
        },
        {
          title: "Growth & Innovation",
          description: "Continuously adopting new technologies for better efficiency.",
          icon: TrendingUp,
        },
        {
          title: "Commitment to Clients",
          description: "Partnerships based on trust, transparency, and mutual success.",
          icon: Award,
        },
      ]}
  ...
  <div id="team" data-section="team">
      ...
      team={[
        ...
        },
        {
          ...
          imageAlt: "Jane Smith, Head of Operations",
        },
        {
          id: "t3",
          name: "David Lee",
          ...
          imageAlt: "David Lee, Global Sales Director",
        },
        {
          id: "t4",
          name: "Sarah Chen",
          role: "Client Relations Manager",
          imageSrc: "http://img.b2bpic.net/free-photo/woman-call-center_1398-4739.jpg",
          imageAlt: "Sarah Chen, Client Relations Manager",
        },
        {
          id: "t5",
          name: "Mark Wilson",
          role: "Logistics Technology Lead",
          ...
          imageAlt: "Portrait of smiling warehouse worker with tablet standing in storage department",
        },
      ]}
